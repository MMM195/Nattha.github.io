      ...
      <div class="detail-info">
        ...
        <div class="detail-facts">
          ...
          <div class="fact">
            ...
            <span class="fact-value">${room.capacity} ท่าน <small>/ห้องย่อย</small></span>
          </div>
          ${room.quantity != null ? `
          <div class="fact">
            <span class="fact-label">ห้องย่อยภายใน</span>
            <span class="fact-value">${room.quantity} ห้อง <small>(รวมสูงสุด ${room.capacity * room.quantity} ท่าน)</small></span>
          </div>` : ''}
          <div class="fact">
